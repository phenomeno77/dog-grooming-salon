  ...
  <div>
    ...
    <section class="bg-sand-100">
      <div class="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        <UiSectionTitle
          eyebrow="Leistungen"
          title="Vom kurzen Bad bis zur kompletten Verwandlung."
          description="Alle Preise sind Richtwerte – was dein Hund wirklich braucht,
    ...
    <section class="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
      <UiSectionTitle
        ...
        description=" Nicht die mit dem Geldbeutel – die mit der Rute. Frei übersetzt aus dem
        Hündischen."
      />
    ...
    <section class="bg-sand-100">
      <div class="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        <UiSectionTitle
          eyebrow="Aktuelles"
          title="Was es bei uns gerade Neues gibt."
          description="  Terminlage, Urlaubszeiten und alles, was du vor deinem Besuch wissen
          solltest."
        />
    ...
    <section class="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
      <div class="grid gap-x-12 gap-y-8 lg:grid-cols-[1fr_1.2fr] lg:gap-y-6">
        ...
        <div class="lg:col-start-1 lg:row-start-1 lg:self-end">
          <UiSectionTitle
            eyebrow="Das Team"
            title=" Zwei Paar Hände, die wissen, was sie tun."
          />
        </div>
    ...
    <!-- CTA -->
    <UiCtaSection
      title="Noch keinen Termin?"
      description="Schreib uns kurz, worum es geht – wir melden uns meist noch am selben Tag zurück."
